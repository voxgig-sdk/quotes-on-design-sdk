...
// QuotesOnDesign SDK utility: fetcher

class QuotesOnDesignFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; QuotesOnDesignSDK/1.0)';
    ...
    public static function call(QuotesOnDesignContext $ctx, string $fullurl, array $fetchdef): array
    {
