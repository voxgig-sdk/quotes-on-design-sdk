...
from quotesondesign_sdk.utility import register

# Load features
from quotesondesign_sdk.feature.base_feature import QuotesOnDesignBaseFeature
from quotesondesign_sdk.features import _has_feature, _make_feature
...
class QuotesOnDesignSDK:
    ...
    def get_utility(self):
        return QuotesOnDesignUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("QuotesOnDesignSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Post(self, data=None) -> "PostEntity":
        ...
        from quotesondesign_sdk.entity.post_entity import PostEntity
        return PostEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "QuotesOnDesignSDK":
        if sdkopts is None:
            sdkopts = {}
