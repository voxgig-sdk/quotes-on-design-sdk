...
// QuotesOnDesign SDK telemetry feature
...
class QuotesOnDesignTelemetryFeature extends QuotesOnDesignBaseFeature
{
    ...
    private function _close(QuotesOnDesignContext $ctx, bool $ok): void
    {
