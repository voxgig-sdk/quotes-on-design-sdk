...
| `categories` | `table` | No | The terms assigned to the post in the category taxonomy |
...
| `tags` | `table` | No | The terms assigned to the post in the post_tag taxonomy |
