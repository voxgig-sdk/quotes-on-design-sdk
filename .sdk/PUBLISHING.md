...
|---|---|---|
| `ts/` | @voxgig-sdk/quotes-on-design-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/quotes-on-design-sdk \
      --repository voxgig-sdk/quotes-on-design-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/quotes-on-design-sdk` shows it, and
`npm trust revoke @voxgig-sdk/quotes-on-design-sdk --id=<id>` removes it.
