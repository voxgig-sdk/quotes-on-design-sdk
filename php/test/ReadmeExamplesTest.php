...
// QuotesOnDesign SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (QuotesOnDesignSDK::test)
...
{
    private const SDK_CLASS = 'QuotesOnDesignSDK';
    ...
    private const SDK_BASE = 'quotesondesign_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../quotesondesign_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
