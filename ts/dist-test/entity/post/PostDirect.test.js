...
(0, node_test_1.describe)('PostDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.QuotesOnDesignSDK({
...
function liveScenariosActive() { return false && process.env.QUOTES_ON_DESIGN_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.QuotesOnDesignSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['QUOTES_ON_DESIGN_TEST_POST_ENTID'];
    ...
    const client = new __1.QuotesOnDesignSDK({
        base: 'http://localhost:8080',
