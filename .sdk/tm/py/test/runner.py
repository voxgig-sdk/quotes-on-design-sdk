...
class QuotesOnDesignTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = QuotesOnDesignTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = QuotesOnDesignTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = QuotesOnDesignTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
