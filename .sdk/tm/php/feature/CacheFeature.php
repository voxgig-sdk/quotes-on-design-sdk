...
// QuotesOnDesign SDK cache feature
...
class QuotesOnDesignCacheFeature extends QuotesOnDesignBaseFeature
{
    ...
    private function _through(QuotesOnDesignContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
