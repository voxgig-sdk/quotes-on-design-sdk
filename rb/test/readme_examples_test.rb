...
#      offline in seeded test mode (QuotesOnDesignSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "QuotesOnDesign_sdk.rb")
  SDK_CLASS = "QuotesOnDesignSDK"
