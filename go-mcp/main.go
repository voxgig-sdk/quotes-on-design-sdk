// Command QuotesOnDesign-mcp is an MCP server exposing the QuotesOnDesign
// SDK as MCP tools.
//
// Two tools are registered:
//
//	QuotesOnDesign_list  — list records of an entity
//	QuotesOnDesign_load  — load a single record of an entity
//
