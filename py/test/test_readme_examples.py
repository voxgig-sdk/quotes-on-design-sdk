# QuotesOnDesign SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions QuotesOnDesignSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both QuotesOnDesignSDK(...) and QuotesOnDesignSDK.test(...) become
#      QuotesOnDesignSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "quotesondesign_sdk"
_SDK_CLASS = "QuotesOnDesignSDK"
