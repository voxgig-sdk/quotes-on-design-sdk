...
class QuotesOnDesignTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = QuotesOnDesignTestRunner.getenv("QUOTESONDESIGN_TEST_LIVE")
        override = QuotesOnDesignTestRunner.getenv("QUOTESONDESIGN_TEST_OVERRIDE")
        ...
        explain = QuotesOnDesignTestRunner.getenv("QUOTESONDESIGN_TEST_EXPLAIN")
