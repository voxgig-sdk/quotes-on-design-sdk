...
func (sdk *QuotesOnDesignSDK) OptionsMap() map[string]any {
...
func (sdk *QuotesOnDesignSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *QuotesOnDesignSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *QuotesOnDesignSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *QuotesOnDesignSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *QuotesOnDesignSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *QuotesOnDesignSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("QuotesOnDesignSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *QuotesOnDesignSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *QuotesOnDesignSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("QuotesOnDesignSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *QuotesOnDesignSDK) Post(data map[string]any) QuotesOnDesignEntity {
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *QuotesOnDesignSDK {
	...
	sdk := NewQuotesOnDesignSDK(sdkopts)
	sdk.Mode = "test"
