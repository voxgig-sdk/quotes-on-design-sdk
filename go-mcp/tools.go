...
func registerTools(server *mcp.Server, client *sdk.QuotesOnDesignSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "quotes-on-design_list",
		Description: "List records from QuotesOnDesign. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "quotes-on-design_load",
		Description: "Load a single record from QuotesOnDesign. " +
...
func runOp(client *sdk.QuotesOnDesignSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.QuotesOnDesignSDK, name string) (sdk.QuotesOnDesignEntity, error) {
