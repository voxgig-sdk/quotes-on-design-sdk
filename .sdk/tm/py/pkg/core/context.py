...
from projectname_sdk.core.control import QuotesOnDesignControl
...
class QuotesOnDesignContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = QuotesOnDesignControl()
        ...
        if isinstance(sp, QuotesOnDesignSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, QuotesOnDesignResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, QuotesOnDesignResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return QuotesOnDesignOperation({})
    ...
    def make_error(self, code, msg):
        return QuotesOnDesignError(code, msg, self)
