...
// QuotesOnDesign SDK streaming feature
...
class QuotesOnDesignStreamingFeature extends QuotesOnDesignBaseFeature
{
    ...
    private function _iterate(QuotesOnDesignResult $result): \Generator
    {
    ...
    private function _streamable(QuotesOnDesignContext $ctx): bool
    {
