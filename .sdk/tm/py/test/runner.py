...
class QuotesOnDesignTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = QuotesOnDesignTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = QuotesOnDesignTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = QuotesOnDesignTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
