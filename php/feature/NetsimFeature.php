...
// QuotesOnDesign SDK netsim feature
...
class QuotesOnDesignNetsimFeature extends QuotesOnDesignBaseFeature
{
    ...
    private function _simulate(QuotesOnDesignContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(QuotesOnDesignContext $ctx, array $applied): void
    {
        $client = $this->client;
