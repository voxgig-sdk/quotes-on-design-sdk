...
// QuotesOnDesign SDK rbac feature
...
class QuotesOnDesignRbacFeature extends QuotesOnDesignBaseFeature
{
    ...
    private function _required(QuotesOnDesignContext $ctx): ?string
    {
    ...
    private function _reject(QuotesOnDesignContext $ctx, string $required): void
    {
    ...
    private function _track(QuotesOnDesignContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
