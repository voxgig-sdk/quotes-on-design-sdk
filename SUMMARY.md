...
Results: Successful response with an array of quote posts; Successful response with a single quote post.
...
- Production server: `https://quotesondesign.com/wp-json/wp/v2`
...
- `quotes-on-design_list`: List records for an entity. Supported entities: `post`.
- `quotes-on-design_load`: Load one record for an entity. Supported entities: `post`.
