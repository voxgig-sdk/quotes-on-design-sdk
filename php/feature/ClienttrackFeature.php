...
// QuotesOnDesign SDK clienttrack feature
...
class QuotesOnDesignClienttrackFeature extends QuotesOnDesignBaseFeature
{
    ...
    public function PostConstruct(QuotesOnDesignContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'QuotesOnDesign-SDK';
