# QuotesOnDesign Golang SDK Reference

Complete API reference for the QuotesOnDesign Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *QuotesOnDesignSDK`
...
#### `Post(data map[string]any) QuotesOnDesignEntity`
...
| `meta` | `map[string]any` | No | Meta fields |
