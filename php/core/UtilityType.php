...
// QuotesOnDesign SDK utility type

class QuotesOnDesignUtility
{
    ...
    public static function copy(QuotesOnDesignUtility $src): QuotesOnDesignUtility
    {
        $u = new QuotesOnDesignUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
