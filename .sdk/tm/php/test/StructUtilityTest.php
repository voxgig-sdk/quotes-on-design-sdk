...
// QuotesOnDesign SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = QuotesOnDesignOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(QuotesOnDesignOmni::structfix($now, Struct::undef()))
                        !== json_encode(QuotesOnDesignOmni::structfix($val, Struct::undef()))) {
