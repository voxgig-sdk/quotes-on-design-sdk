...
// QuotesOnDesign SDK timeout feature
...
class QuotesOnDesignTimeoutFeature extends QuotesOnDesignBaseFeature
{
    ...
    private function _with_timeout(QuotesOnDesignContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(QuotesOnDesignContext $_ctx, float $ms): void
    {
        $client = $this->client;
