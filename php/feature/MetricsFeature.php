...
// QuotesOnDesign SDK metrics feature
...
class QuotesOnDesignMetricsFeature extends QuotesOnDesignBaseFeature
{
    ...
    private function _record(QuotesOnDesignContext $ctx, bool $ok): void
    {
