...
// QuotesOnDesign SDK idempotency feature
...
class QuotesOnDesignIdempotencyFeature extends QuotesOnDesignBaseFeature
{
    ...
    private function _mutating(QuotesOnDesignContext $ctx): bool
    {
