...
func registerSDKWords(r *eng.Registry, client *sdk.QuotesOnDesignSDK) {
...
func runOp(client *sdk.QuotesOnDesignSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
