...
// QuotesOnDesign SDK ratelimit feature
...
class QuotesOnDesignRatelimitFeature extends QuotesOnDesignBaseFeature
{
    ...
    private function _acquire(QuotesOnDesignContext $ctx): void
    {
    ...
    private function _track(QuotesOnDesignContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
