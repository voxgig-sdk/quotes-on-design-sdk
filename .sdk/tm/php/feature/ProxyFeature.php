...
// QuotesOnDesign SDK proxy feature
...
class QuotesOnDesignProxyFeature extends QuotesOnDesignBaseFeature
{
    ...
    public function init(QuotesOnDesignContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (QuotesOnDesignContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
