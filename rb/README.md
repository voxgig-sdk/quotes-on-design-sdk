# QuotesOnDesign Ruby SDK



The Ruby SDK for the QuotesOnDesign API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `QuotesOnDesignError` (a `StandardError` subclass), so wrap
...
```
rb/
├── QuotesOnDesign_sdk.rb       -- Main SDK module
