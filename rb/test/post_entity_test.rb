...
class PostEntityTest < Minitest::Test
  ...
  def test_stream
    ...
    base = QuotesOnDesignSDK.test(seed, nil)
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set QUOTES_ON_DESIGN_TEST_POST_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def post_basic_setup(extra)
  ...
  entid_env_raw = ENV["QUOTES_ON_DESIGN_TEST_POST_ENTID"]
