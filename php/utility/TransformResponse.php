...
// QuotesOnDesign SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class QuotesOnDesignTransformResponse
{
    public static function call(QuotesOnDesignContext $ctx): mixed
    {
        ...
        $transform = QuotesOnDesignHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
