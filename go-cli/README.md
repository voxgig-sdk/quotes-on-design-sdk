...
AQL-driven CLI and REPL for the QuotesOnDesign SDK. Positional arguments are
...
```sh
go build -o quotes-on-design-cli ./...
```
...
./quotes-on-design-cli load 1 post
./quotes-on-design-cli load '{id:1}' post
