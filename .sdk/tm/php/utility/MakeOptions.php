...
// QuotesOnDesign SDK utility: make_options

class QuotesOnDesignMakeOptions
{
    ...
    public static function call(QuotesOnDesignContext $ctx): array
    {
        ...
        //
        // `QuotesOnDesignSchema::optspec()` is built from the model:
        ...
        $optspec = QuotesOnDesignSchema::optspec();
