...
// QuotesOnDesign SDK utility: graphql
//
...
class QuotesOnDesignGraphql
{
    ...
    // equivalent.
    public static function body(QuotesOnDesignContext $ctx): mixed
    {
    ...
    public static function errors(QuotesOnDesignContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
