...
// QuotesOnDesign SDK audit feature
...
class QuotesOnDesignAuditFeature extends QuotesOnDesignBaseFeature
{
    ...
    private function _emit(QuotesOnDesignContext $ctx, string $outcome): void
    {
