...
The Golang SDK for the QuotesOnDesign API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/quotes-on-design-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/quotes-on-design-sdk=../path/to/github.com/voxgig-sdk/quotes-on-design-sdk
```
...
```
github.com/voxgig-sdk/quotes-on-design-sdk/
...
The root package (`github.com/voxgig-sdk/quotes-on-design-sdk`) re-exports everything needed
